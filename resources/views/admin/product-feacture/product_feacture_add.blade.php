...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <form action="{{route('productFeactureStore')}}"method="post" id="addform" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control product_name" name="product_name"  placeholder="Enter product name">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="form-check form-checkbox-success mb-2 form-check-inline">
                                            <input type="radio" id="yarn_type_yes" value="1" name="yarn_type" class="form-check-input yarn_type">
                                            <label class="form-check-label" for="yarn_type_yes">Yes</label>
                                        </div>
                                        <div class="form-check  form-checkbox-danger mb-2 form-check-inline">
                                            <input type="radio" id="yarn_type_no"  value="0" name="yarn_type" class="form-check-input yarn_type">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="form-check form-checkbox-success mb-2 form-check-inline">
                                            <input type="radio" id="brand_yes" value="1" name="brand" class="form-check-input brand">
                                            <label class="form-check-label" for="brand_yes">Yes</label>
                                        </div>
                                        <div class="form-check  form-checkbox-danger mb-2 form-check-inline">
                                            <input type="radio" id="brand_no" value="0" name="brand" class="form-check-input brand">
                                            <label class="form-check-label" for="brand_no">No</label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-checkbox-success mb-2 form-check-inline">
                                            <input type="radio" id="color_yes" value="1" name="color" class="form-check-input color">
                                            <label class="form-check-label" for="color_yes">Yes</label>
                                        </div>
                                        <div class="form-check  form-checkbox-danger mb-2 form-check-inline">
                                            <input type="radio" id="color_no" value="0" name="color" class="form-check-input color">
                            ...
                            <div class="row unit_check">
                                <h6 class="font-15 mt-3">Unit</h6>
                                <div class="mt-2">                                           
                                    <div class="form-check form-checkbox-info mb-2 form-check-inline unit_type">
                                        <input type="radio" id="unit_type_yes" value="1" name="unit_type" class="form-check-input unit_type">
                                        <label class="form-check-label" for="unit_type_yes">Yes</label>
                                    </div>
                                    <div class="form-check  form-checkbox-danger mb-2 form-check-inline">
                                        <input type="radio" id="unit_type_no"  value="0" name="unit_type" class="form-check-input unit_type">
                                        <label class="form-check-label" for="unit_type_no">No</label>
                                    </div>
                                    <span style="color:red;" id="unit_type"></span>
                                </div>
                                <div class="unit_type_check d-none" style="margin-left:23px;">
                                    <div class="mt-2">
                                        <div class="form-check form-checkbox-success mb-2 form-check-inline">
                                            <input type="checkbox" name="weight" id="weight" value="1" class="form-check-input weight" id="weight">
                                        ...
                                        <div class="weight_check d-none"  style="margin-left: 23px;">
                                            <div class="form-check  mb-2 form-check-inline">
                                                <input type="checkbox" name="Weights_kgs" value="1" class="form-check-input" id="weightKgCheck">
                                        ...
                                        <div class="form-check  form-checkbox-success mb-2 form-check-inline">
                                            <input type="checkbox" name="cartoon" id="cartoon" value="1"  class="form-check-input cartoon" id="cartoon">
                                            <label class="form-check-label" for="cartoon">Cartoon</label>
                                        </div>
                                        <div class="cartoon_check d-none"  style="margin-left:23px;">
                                            <div class="form-check  mb-2 form-check-inline">
                                                <input type="checkbox" name="cartoon_small" value="1" id="cartoon_small" class="form-check-input cartoon_small" id="cartoon_small">
                                            ...
                                            <div class="form-group mb-2 col-lg-2  cartoon_qty_small_check d-none" style="margin-left: 23px;">
                                                <input type="text" class="form-control" id="cartoon_small_qty" name="cartoon_qty_small"  placeholder="Enter quantity ">
                                                <span style="color:red;" id="cartoon_small_qty"></span>
                                            </div>

                                            <div class="form-check  mb-2 form-check-inline">
                                                <input type="checkbox" name="cartoon_medium" value="1" class="form-check-input" id="cartoon_medium">
                                            ...
                                            <div class="form-group mb-2 col-lg-2 d-none cartoon_qty_medium_check" style="margin-left: 23px;">
                                                <input type="text" class="form-control" id="cartoon_medium_qty" name="cartoon_medium_qty"  placeholder="Enter quantity ">
                                                <span style="color:red;" id="cartoon_medium_qty"></span>
                                            </div>

                                            <div class="form-check  mb-2 form-check-inline">
                                                <input type="checkbox" name="cartoon_large" value="1"  class="form-check-input" id="cartoon_large">
                                            ...
                                            <div class="form-group mb-2 col-lg-2 d-none cartoon_qty_large_check" style="margin-left: 23px;">
                                                <input type="text" class="form-control" id="cartoon_large_qty" name="cartoon_large_qty"  placeholder="Enter quantity ">
                                                <span style="color:red;" id="cartoon_large_qty"></span>
                                            </div>
                                            <div class="form-check mb-2 form-check-inline">
                                                <input type="checkbox" name="cartoon_exrta_large" value="1"  class="form-check-input" id="cartoon_exrta_large">
                                            ...
                                            <div class="form-group mb-2 col-lg-2 d-none cartoon_qty_extra_large_check" style="margin-left: 23px;">
                                                <input type="text" class="form-control" id="cartoon_extar_large_qty" name="cartoon_extar_large_qty"  placeholder="Enter quantity ">
                                                <span style="color:red;" id="cartoon_extar_large_qty"></span>
                                            </div>
                                            <div class="form-check mb-2 form-check-inline ">
                                                <input type="checkbox" name="cartoon_exrta_xxl" value="1"  class="form-check-input cartoon_exrta_xxl" id="cartoon_exrta_xxl">
                                            ...
                                            <div class="form-group mb-2 col-lg-2 d-none cartoon_qty_extra_large_xxl_check" style="margin-left: 23px;">
                                                <input type="text" class="form-control" id="cartoon_extar_large_xxl_qty" name="cartoon_extar_large_xxl_qty"  placeholder="Enter quantity ">
                                                <span style="color:red;" id="cartoon_extar_large_xxl_qty"></span>
                                            </div>

                                        </div>
                                        <div class="form-check form-checkbox-success  mb-2 form-check-inline">
                                            <input type="checkbox" name="box" value="1" class="form-check-input" id="box">
                                            <label class="form-check-label" for="box">Box</label>
                                        </div>
                                        <div class="form-group mb-2 col-lg-2 d-none box_check" style="margin-left: 23px;">
                                            <input type="text" class="form-control" id="box_qty" name="box_qty"  placeholder="Enter quantity ">
                                            <span style="color:red;" id="box_qty"></span>
                                        </div>
                                        <div class="form-check form-checkbox-success  mb-2 form-check-inline">
                                            <input type="checkbox" name="dozon" value="1" class="form-check-input" id="dozon">
                                        ...
                                        <div class="form-group mb-2 col-lg-2 d-none dozon_check" style="margin-left: 23px;">
                                            <input type="text" class="form-control" id="dozon_qty" name="dozon_qty"  placeholder="Enter quantity ">
                                            <span style="color:red;" id="dozon_qty"></span>
                                        </div>
                                        <div class="form-check form-checkbox-success mb-2 form-check-inline">
                                            <input type="checkbox" name="pices" value="1" class="form-check-input" id="pices">
                                        ...
                                        <div class="form-group mb-2 col-lg-2 d-none roll_check" style="margin-left: 23px;">
                                            <input type="text" class="form-control" id="roll_qty" name="roll_qty"  placeholder="Enter quantity ">
