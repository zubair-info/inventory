                                ...
                                <tbody>
                                    @foreach ($add_product_feacture as $key=>$product_feacture)       
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="product_feacture">
                                                    @php
                                                        ...
                                                        echo 'Brand' . ' , ';
                                                        }if($product_feacture->yarn_type){
                                                            echo 'YarnType' . ' <span> , </span> ';
                                                        }if($product_feacture->yarn_type==1){
                                                            echo 'Material Type' . '<span> , </span>';
                                            ...
                                            {{-- <td> {{$product_feacture->yarn_type}}</td>
                                            <td> {{$product_feacture->brand}}</td>
                                            <td> {{$product_feacture->matiral_type}}</td>
                                            <td> {{$product_feacture->color}}</td>
                                            <td> 
                                                <div class="form-check  mb-2 form-check-inline">
                                                    <input type="checkbox"  {{  ($product_feacture->unit_type == 1 ? ' checked' : '') }} name="unit_type"  class="form-check-input" id="customCheckunt"> 
                                                    <label class="form-check-label" for="customCheckunt"></label>
                                                </div>
                                               
                                            </td>
                                            <td> 
                                                <div class="form-check  mb-2 form-check-inline">
                                                    <input type="checkbox"  {{  ($product_feacture->weight == 1 ? ' checked' : '') }} name="cartoon_large"  class="form-check-input" id="customCheck3">
                                                    <label class="form-check-label" for="customCheck3">Weight</label>
                                                </div>
                                                <div class="form-check  mb-2 form-check-inline" style="margin-left:23px;">
                                                    <input type="checkbox"  {{  ($product_feacture->weight_kg == 1 ? ' checked' : '') }} name="cartoon_large"  class="form-check-input" id="customCheck3">
                                                    <label class="form-check-label" for="customCheck3">Kg</label>
                                                </div>
                                                <div class="form-check  mb-2 form-check-inline"  style="margin-left:23px;">
                                                    <input type="checkbox"  {{  ($product_feacture->weight_pound == 1 ? ' checked' : '') }} name="cartoon_large"  class="form-check-input" id="customCheck3">
                                                    <label class="form-check-label" for="customCheck3">Pound</label>
                                                </div>

                                            </td>
                                            <td>
                                                 {{$product_feacture->weight_kg}}
                                            </td>
                                            <td> {{$product_feacture->cartoon}}</td>
                                            <td> {{$product_feacture->cartoon_small}}</td>
                                            <td> {{$product_feacture->cartoon_qty_small}}</td>
                                            <td> {{$product_feacture->cartoon_medium}}</td>
                                            <td> {{$product_feacture->cartoon_medium_qty}}</td>
                                            <td> {{$product_feacture->cartoon_large}}</td>
                                            <td> {{$product_feacture->cartoon_large_qty}}</td>
                                            <td> {{$product_feacture->cartoon_exrta_large}}</td>
                                            <td> {{$product_feacture->cartoon_extar_large_qty}}</td>
                                            <td> {{$product_feacture->cartoon_exrta_xxl}}</td>
                                            <td> {{$product_feacture->cartoon_extar_large_xxl_qty}}</td>
                                            <td> {{$product_feacture->dozon}}</td>
                                            <td> {{$product_feacture->dozon_qty}}</td>
                                            <td> {{$product_feacture->box}}</td>
                                            <td> {{$product_feacture->box_qty}}</td>
                                            <td> {{$product_feacture->pices}}</td>
                                            <td> {{$product_feacture->pices_qty}}</td>
                                            <td> {{$product_feacture->roll}}</td>
                                            <td> {{$product_feacture->roll_qty}}</td>
                                            <td> {{$product_feacture->rate}}</td> --}}
                                            {{-- <td> {{$product_feacture->product_feacture_phone}}</td>
                                            <td> {{$product_feacture->product_feacture_email}}</td>
                                            <td> {{$product_feacture->product_feacture_address}}</td> --}}
                                            <td class="table-action">
                                                <a href="{{route('product_feacture_edit',$product_feacture->id)}}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                <a class="action-icon" data-bs-target="#delete_modal_{{$product_feacture->id}}" data-bs-toggle="modal" href="#delete_modal_{{$product_feacture->id}}"> <i class="mdi mdi-delete"></i></a>
                                            </td>
