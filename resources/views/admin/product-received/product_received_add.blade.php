                    ...
                    <form id="product_received_store">
                        <div class="row">
                            <div class="row">
                                ...
                                @endphp
                                <input type="hidden" name="product_uid" id="product_uid" value="{{$product_uid}}" class="form-control">
                                <div class="col-lg-4">
                                    <div class="mb-3">
...
<script>
    ...
    $('#product_select2').change(function() {
        ...
        $.ajax({
           ...
           success:function(data){
                ...
                html = '<tr>';
                // html += '<input type="hidden" name="form_count_'+count+'" value="'+count+'" class="form-control">';
                ...
                if(data.success.unit_type==1){
                    ...
                    html += '<input type="hidden" id="unit_type" name="unit_type[]" value="'+data.success.unit_type+'" class="form-control" >';
                    if(data.success.weight==1){

                        html += '<input type="hidden"  name="weight_'+count+'" value="'+data.success.weight+'" class="form-control" >';
                            if(data.success.weight_kg){
                                html += '<input type="hidden" name="weight_kg_'+count+'" value="'+data.success.weight_kg+'" class="form-control">';
                            ...
                            if(data.success.weight_pound){
                                html += '<input type="hidden" name="weight_pound_'+count+'" value="'+data.success.weight_pound+'" class="form-control">';
                    ...
                    if(data.success.cartoon==1){
                            html += '<input type="hidden" name="cartoon_'+count+'" value="'+data.success.cartoon+'" class="form-control" >';
                        if(data.success.cartoon_small==1){
                            html += '<input type="hidden" name="cartoon_small_'+count+'" value="'+data.success.cartoon_small+'" class="form-control" >';
                            if(data.success.cartoon_qty_small){
                                html +='<label class="form-label">Cartoon(S)</label><input type="text" name="cartoon_qty_small_'+count+'" placeholder="Small Qty" class="form-control form-control-sm" id="colFormLabelSm" >';
                            }
                        }
                        if(data.success.cartoon_medium==1){
                            html += '<input type="hidden" name="cartoon_medium_'+count+'" value="'+data.success.cartoon_medium+'" class="form-control" >';
                            if(data.success.cartoon_medium_qty){
                                html +='<label  class="form-label">>Cartoon(M)</label><input type="text" name="cartoon_medium_qty_'+count+'" placeholder="Medium Qty" class="form-control form-control-sm" id="colFormLabelSm" >';
                            }
                            
                        }
                        if(data.success.cartoon_large==1){
                            html += '<input type="hidden" name="cartoon_large_'+count+'" value="'+data.success.cartoon_large+'" class="form-control" >';
                            if(data.success.cartoon_large_qty){
                                html +='<label  class="form-label">Cartoon(L)</label><input type="text" name="cartoon_large_qty_'+count+'" placeholder="Large Qty" class="form-control form-control-sm" id="colFormLabelSm" >';
                            }
                            
                        }
                        if(data.success.cartoon_exrta_large==1){
                            html += '<input type="hidden" name="cartoon_exrta_large_'+count+'" value="'+data.success.cartoon_exrta_large+'" class="form-control" >';
                            if(data.success.cartoon_extar_large_qty){
                                html +='<label  class="form-label">Cartoon(XL)</label><input type="text" name="cartoon_extar_large_qty_'+count+'" placeholder="XL Qty" class="form-control form-control-sm" id="colFormLabelSm" >';
                            }
                            
                        }
                        if(data.success.cartoon_exrta_xxl==1){
                            html += '<input type="hidden" name="cartoon_exrta_xxl_'+count+'" value="'+data.success.cartoon_exrta_xxl+'" class="form-control" >';
                            if(data.success.cartoon_extar_large_xxl_qty){
                                html +='<label  class="form-label">Cartoon(XXL)</label><input type="text" name="cartoon_extar_large_xxl_qty_'+count+'" placeholder="XXL Qty" class="form-control form-control-sm" id="colFormLabelSm">';
                            }
                    ...
                    if(data.success.dozon){
                        html += '<input type="hidden" name="dozon_'+count+'" value="'+data.success.dozon+'" class="form-control" >';
                        if(data.success.dozon_qty){
                            html +='<label class="form-label">Dozon</label><input type="text" name="dozon_qty_'+count+'" placeholder="Dozon Qty" class="form-control form-control-sm" id="dozon_qty" >';
                        }
                    }
                    if(data.success.box){
                        html += '<input type="hidden" name="box_'+count+'" value="'+data.success.box+'" class="form-control" >';
                        if(data.success.box_qty){
                            html +='<label class="form-label">Box</label><input type="text" name="box_qty_'+count+'" placeholder="Box Qty" class="form-control form-control-sm" id="box_qty" >';
                        }
                    }
                    if(data.success.pices){
                        html += '<input type="hidden" name="pices_'+count+'" value="'+data.success.pices+'" class="form-control" >';
                        if(data.success.pices_qty){
                            html +='<label class="form-label">Pices</label><input type="text" name="pices_qty_'+count+'" placeholder="Pices Qty" class="form-control form-control-sm" id="pices_qty" >';
                        }
                    }
                    if(data.success.roll){
                        html += '<input type="hidden" name="roll_'+count+'" value="'+data.success.roll+'" class="form-control" >';
                        if(data.success.roll_qty==1){
                            html +='<label class="form-label">Roll</label><input type="text" name="roll_qty_'+count+'" placeholder="Roll Qty" class="form-control form-control-sm" id="roll_qty" >';
                        }
    ...
    $('#product_received_store').on('submit', function(event) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function(data){
                toastr.success('Add Product Received');
